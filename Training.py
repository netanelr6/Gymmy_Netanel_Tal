...
class Training(threading.Thread):
    ...
    def training_session(self):
        ...
        #               "open_and_close_arms_90", "raise_arms_forward"]
        exercise_names = ["raise_arms_bend_elbows", "bend_elbows", "open_and_close_arms",
                      "open_and_close_arms_90", "raise_arms_forward"]
        ...
        for e in exercise_names:
            if e == "bend_elbows" :
                if s.Team_Number == 1:
                    ...
                    s.inter_aff = True
            time.sleep(3) # wait between exercises
            if s.reboot_flag:
    ...
    def run_exercise(self, name, hand=''):
        ...
        say(name+hand)
        time.sleep(1.5)  # Delay the robot movement after the audio is played
        s.req_exercise = name
